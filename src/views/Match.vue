    ...
    <div class="lg:w-[413px] w-full z-10 bg-bg_match py-5 pl-20 shadow-md drop-shadow-xl">
      ...
      <section>
        ...
        <button @click="clickFindBtn('any')" :class="{ 'btn-clicked': wantToFind.any }"
          class="btn-lg text-4xl">不拘</button>
      </section>
      <!-- 性別 -->
      <section>
        <p class="font-PeNi_black mb-1 mt-2 text-base">性別</p>
        <button @click="clickGenderBtn('male')" :class="{ 'btn-clicked': gender.male }" class="btn-lg text-PeNi_blue">
          <n-icon size="36">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
              role="img" class="iconify iconify--ant-design" width="32" height="32" preserveAspectRatio="xMidYMid meet"
      ...
      <!-- 套用 -->
      <button
        class="mt-2 h-[50px] w-[290px] rounded-2xl bg-PeNi_black text-base font-medium text-white hover:border hover:bg-white hover:text-black">套用</button>
    </div>
